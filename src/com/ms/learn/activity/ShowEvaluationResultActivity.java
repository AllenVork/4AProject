...
public class ShowEvaluationResultActivity extends Activity {
	...
	private void initUI() {
		...
		tvTitle.setText(R.string.evaResultTitle);
		findViewById(R.id.bt_newsdetailBack).setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				ShowEvaluationResultActivity.this.finish();
			}
		});
		url=getIntent().getExtras().getString("resultUrl");
		...
		protected void onPostExecute(Void result) {
	        ...
	        {  
	            ...
	            public void openFileChooser(ValueCallback<Uri> uploadMsg) {  
	                ...
	                i.setType("image/*");  
	                ShowEvaluationResultActivity.this.startActivityForResult(Intent.createChooser(i,"File Chooser"), UPLOADDATA);  
	            ...
	            //   i.setType("*/*");
	               i.setType("image/*");  
	               ShowEvaluationResultActivity.this.startActivityForResult(
