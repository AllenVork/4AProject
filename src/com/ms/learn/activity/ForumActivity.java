...
public class ForumActivity extends Activity {
	...
	private void initUI() {
		mProgrDialog=(ProgrDialog) findViewById(R.id.froumProgrDialog);
		mWebView=(WebView) findViewById(R.id.froumbody);
		...
		protected void onPostExecute(Void result) {
	        ...
	        {  
	            ...
	            public void openFileChooser(ValueCallback<Uri> uploadMsg) {  
	                ...
	                i.setType("image/*");  
	                ForumActivity.this.startActivityForResult(Intent.createChooser(i,"File Chooser"), UPLOADDATA);  
	            ...
	            //   i.setType("*/*");
	               i.setType("image/*");  
	               ForumActivity.this.startActivityForResult(
	        ...
	        mWebView.loadUrl("http://es.whu.edu.cn/weixuexi/forum/Default.aspx?uid=1");
